...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='homepage',
            name='body',
            field=wagtail.core.fields.RichTextField(blank=True, help_text='Optional body text'),
        ),
        migrations.AddField(
            model_name='homepage',
            name='faceplate',
            field=models.ForeignKey(blank=True, help_text='Homepage faceplate', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.Image'),
        ),
        migrations.AddField(
            model_name='homepage',
            name='image',
